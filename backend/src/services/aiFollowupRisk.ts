export interface FollowupRiskInput {
  isHighRiskPregnancy?: boolean;
  hasChronicCondition?: boolean;
  overdueDays?: number;
  missedPreviousFollowups?: number;
  recentAbnormalVitals?: boolean;
  age?: number;
}
...
export function calculateFollowupRisk(input: FollowupRiskInput): FollowupRiskScore {
