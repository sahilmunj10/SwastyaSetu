...
exports.getDiagnosticRequests = getDiagnosticRequests;
exports.getPublicTestCatalog = getPublicTestCatalog;
exports.createDiagnosticRequest = createDiagnosticRequest;
exports.updateDiagnosticStatus = updateDiagnosticStatus;
const client_1 = require("@prisma/client");
const auditMiddleware_1 = require("../middleware/auditMiddleware");
const prisma = new client_1.PrismaClient();
async function getDiagnosticRequests(req, res) {
    try {
...
async function getPublicTestCatalog(req, res) {
    try {
        const catalog = [
            {
...
async function createDiagnosticRequest(req, res) {
    try {
        const { patientId, facilityId, testName, testCategory, priority, appointmentDate } = req.body;
...
async function updateDiagnosticStatus(req, res) {
    try {
        const { id } = req.params;
        const { status, reportFindings, normalRange, testValue, isAbnormal } = req.body;
